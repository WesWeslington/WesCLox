...
#include <stdarg.h>
#include <string.h>
#include <time.h>// Move this with clock to native function file
...
//TODO: Move native functions into its own file
...
#define BINARY_OP(valueType, op)                                \
    ...
    case OP_ADD:  {
        if(IS_STRING(peek(0)) && IS_STRING(peek(1))){
            ...
            runtimeError("Operands must be two numbres or two strings.");
            return INTERPRET_RUNTIME_ERROR;
        }
        break;
    }
